...
$isSubdis  = ($ID_SUBDIS > 0) && (stripos($ROL, 'subdis') !== false);
...
// Sucursales destino (scope Subdis: solo almacén Eulalia + sucursales del propio subdis; Luga: todas menos origen)
$sucursales = [];
...
if ($isSubdis) {
  $stSuc = $conn->prepare("
    ...
    ORDER BY nombre
  ");
  $stSuc->bind_param("ii", $ID_SUC_ORI, $ID_SUBDIS);
} else {
